...
public class PluginRepositoryIntegrationTest extends DatabaseBasedTest {
    ...
    public void findMaxPortByHost() {
        ...
        PluginInstance pluginInstance = new PluginInstance(null, pluginPackage, "test-instance-container-id", "10.107.117.154", 29999, "running");
    ...
    public void findByPackageIdAndStatus() {
        ...
        PluginInstance pluginInstance = new PluginInstance(null, pluginPackage, "test-instance-container-id", "10.107.117.154", 20000, "RUNNING");
        pluginInstanceRepository.save(pluginInstance);
