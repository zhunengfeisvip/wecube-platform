...
values('2c9280827019695c017019a2d5ac001b','system','2020-02-06 12:05:03',NULL,NULL,b'1',b'0','13912345678',b'0','OPT',NULL,'UM ADMIN','UM管理员','0755-12345678','$2a$10$XH7kL/aIjCKwZZ2CXd5Nk.dFxyP4UubHa7vqekT1IYB1dX./0Hr8m','运维岗','umadmin');
insert  into `auth_sys_user`(`id`,`created_by`,`created_time`,`updated_by`,`updated_time`,`is_active`,`is_blocked`,`cell_phone_no`,`is_deleted`,`dept`,`email_addr`,`english_name`,`local_name`,`office_tel_no`,`password`,`title`,`username`) 
